...
/*
		this.data[0][0]="overcast";
		this.data[0][1]="hot";
		this.data[0][2]="high";
		this.data[0][3]="strong";
		this.data[0][4]="no";

		this.data[1][0]="overcast";
		this.data[1][1]="mild";
		this.data[1][2]="high";
		this.data[1][3]="strong";
		this.data[1][4]="no";
		...
		this.data[3][0]="overcast";
		this.data[3][1]="hot";
		this.data[3][2]="high";
		this.data[3][3]="strong";
		this.data[3][4]="yes";

		this.data[4][0]="overcast";
		this.data[4][1]="hot";
		this.data[4][2]="high";
		this.data[4][3]="strong";
		this.data[4][4]="no";
		...
		this.data[10][0]="sunny";
		this.data[10][1]="cool";
		this.data[10][2]="diocane";
		this.data[10][3]="pio";
		this.data[10][4]="forse";

		this.data[11][0]="sunny";
		this.data[11][1]="cool";
		this.data[11][2]="diocane";
		this.data[11][3]="pio";
		this.data[11][4]="forse";

		this.data[12][0]="sunny";
		this.data[12][1]="cool";
		this.data[12][2]="diocane";
		this.data[12][3]="pio";
		this.data[12][4]="forse";

		this.data[13][0]="sunny";
		this.data[13][1]="cool";
		this.data[13][2]="diocane";
		this.data[13][3]="pio";
		this.data[13][4]="forse";
*/
